...
> **Source:** [Checkpointing documentation](https://google-gemini.github.io/gemini-cli/docs/cli/checkpointing.html)

## Overview

The Gemini CLI includes a **Checkpointing** feature that automatically saves
a snapshot of your project's state before any file modifications are made by
AI-powered tools. This allows you to safely experiment with and apply code
changes, knowing you can instantly revert back to the state before the tool
was run.
...
The Checkpointing feature is **disabled by default**. To enable it, you can
either use a command-line flag or edit your `settings.json` file.
...
are typically composed of a timestamp, the name of the file being modified,
and the name of the tool that was about to be run (e.g.,
`2025-06-22T10-00-00_000Z-my-file.txt-write_file`).

### Restore a Specific Checkpoint

To restore your project to a specific checkpoint, use the checkpoint file
from the list:
